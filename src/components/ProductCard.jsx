export default function ProductCard({ image, title, price, sold, rating, badge }) {
    ...
    return (
        <div className="relative rounded-xl border shadow-sm overflow-hidden transition-all hover:scale-[1.02] bg-white p-2 w-full max-w-[200px]">
