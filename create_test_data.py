...
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'djangocoffee_backend.settings')
django.setup()
...
if __name__ == "__main__":
    # Replace with your test user's email - use your actual user email
    USER_EMAIL = "admin@example.com"  # Change this to your account email
